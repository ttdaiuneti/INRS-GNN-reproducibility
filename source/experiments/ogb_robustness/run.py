...
if len(sys.argv)>1:
 ...
 b.calc_deltas_blocked=calc_deltas_blocked_stable
 ...
 files=[H/'protocol.json',Path(__file__),H/'stable_batch.py',H/'test_stable_batch.py',R/'experiments/e2e_ogb_stream.py',R/'shared/theory/incremental_nrs.py',R/'theory/incremental_rough_adjacency.py']
